...
class FootwearItemDetail extends StatefulWidget {
  final String name;
  final String category;
  final String price;
  final String image;

  const FootwearItemDetail({
    super.key,
    required this.name,
  ...
  @override
  _FootwearItemDetailState createState() => _FootwearItemDetailState();
}

class _FootwearItemDetailState extends State<FootwearItemDetail> {
  ...
  Future<void> _addReview() async {
    // Check the internet connectivity at the beginning
